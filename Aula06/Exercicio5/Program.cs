...
namespace Exercicio5
{
    public class Program
    {
        ...
        private readonly string ficheiro;
        ...
        private static void Main()
        {
            ...
            {
                // Dizer obrigado, quer tenha havido uma exceção ou não
        ...
        private void Comprime()
        {
            ...
            using Stream fs = new FileStream(ficheiro, FileMode.Create, FileAccess.Write);
